...
public class ServidorChat {
    ...
    public static void main(String args[]) throws IOException {
        int puerto = 6000;
        //se crea un objeto ServerSocket que representa el servidor y se 
        //asocia al puerto definido anteriormente
        ServerSocket servidor = new ServerSocket(puerto);
        //se muestra un mensaje en consola para indicar que el servidor ha sido iniciado.
        System.out.println("Servidor iniciado...");
        //Se crea un array de sockets que se utilizará para controlar las 
        //conexiones al servidor.
        Socket tabla[] = new Socket[maxCon];
        //se crea un objeto de la clase ComunHilos, que se utiliza para compartir
        //información entre los hilos que manejan las conexiones de los clientes.
        ComunHilos comun = new ComunHilos(maxCon, 0, 0, tabla);
        //comienza un bucle while que se ejecuta mientras el número de conexiones
