...
public class Pregunta1 extends Fragment implements FragmentController {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.pregunta1, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        grupoBotonesPregunta = view.findViewById(R.id.grupoPreguntas1);
