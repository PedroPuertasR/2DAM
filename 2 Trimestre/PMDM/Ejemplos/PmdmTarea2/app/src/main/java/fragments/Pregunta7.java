...
public class Pregunta7 extends Fragment implements FragmentController {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.pregunta7, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        grupoBotonesPregunta = view.findViewById(R.id.grupoPreguntas7);
