...
public class Pregunta2 extends Fragment implements FragmentController {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.pregunta2, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        grupoBotonesPregunta = view.findViewById(R.id.grupoPreguntas2);
