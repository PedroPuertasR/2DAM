...
public class MainLista
{
	...
	List <Piloto> ps = pilotos.getList();
        ...
        // Buscar cada nombre 10.000.000 veces
	...
	for (int i=0; i<10000000; i++)
        ...
        // Buscar Fernando Alonso 100.000 veces
        inicio = System.currentTimeMillis();
        int cont=0;
	for (int i=0; i<100000; i++)
	    {		
                Piloto pn = pilotos.busca("Fernando Alonso");
                if (pn != null)
                    cont++;
                // No descomentar por eterno
                //System.out.println(pn);		    
        ...
        System.out.println(tiempo +" milisegundos  / " + cont +" veces encontrado");
    }
}
